...
Table \ref{tab:astroDOIs1} lists a short selection of DOI assigned by Data Centers. The list is not exhaustive but shows different usage of DOI  \todo{complete the DOI table?}
